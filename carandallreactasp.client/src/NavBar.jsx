    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
                ...
                <ul className="navbar-nav me-auto mb-2 mb-lg-0 chakra-petch-regular">
                    ...
                    <div className="dropdown me-3">
                        <li className="nav-item">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="voertuigbeheerDropdown">
                                <li>
                                    <NavLink className="dropdown-item" to="/vehiclebeheer">Blokkeren & Deblokkeren</NavLink>
                                </li>
                                <li>
                                    <NavLink className="dropdown-item" to="/managecars">Toevoegen & Verwijderen</NavLink>
                                </li>
                            </ul>
                        </li>
                    </div>
                </ul>
                <ul className="navbar-nav ms-auto mb-2 mb-lg-0 d-flex align-items-center tomorrow-regular">
                    <li className="nav-item me-3">
